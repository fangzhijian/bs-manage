 ...
 * fzj
 */
public interface NotifyCustomerReleaseService extends CommonService<NotifyCustomerRelease> {
     ...
     * @return 客户授权过期通知列表
     */
    Page<NotifyCustomerRelease> getByPage(Integer limit, Integer offset);
}
