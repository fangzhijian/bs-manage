...
public class LogAspect {
     ...
     *   作用:日志中打印出入参
     */
    @Around("@annotation(com.bs.manage.aspect.MethodLog) || @annotation(org.springframework.web.bind.annotation.RequestMapping) " +
            "|| execution(* com.bs.manage..*Impl.*(..)) || @annotation(org.springframework.web.bind.annotation.GetMapping) ||" +
            ...
            if (methodAnnotationRepeatLock){
                ...
                if (repeatLock != null){
                    ...
                    if (getLock == null || !getLock){
                        return ResponseJson.fail(PubCode.P2006_REPEAT_CLICK.code(),PubCode.P2006_REPEAT_CLICK.message());
                    }
                }
            }
            //判断redis资源竞争锁
            ...
            if (methodAnnotationResourceLock){
                ...
                if (resourceLock != null){
                    ...
                    try {
                        ...
                        return ResponseJson.fail(e.getCode(),e.getMessage());
                    }
                }
            }
    ...
    private void tryGetResourceLock(String resourceLockKey, long expireTime, TimeUnit timeUnit,int interVal,int timeOut) throws InterruptedException, BusinessException {
        ...
        while ((getLock = redisTemplate.opsForValue().setIfAbsent(resourceLockKey,1,expireTime,timeUnit)) ==null || !getLock){
            if (System.currentTimeMillis()-startTime>timeOut+interVal){
                throw new BusinessException(PubCode.P2007_RESOURCE_CLICK.code(),PubCode.P2007_RESOURCE_CLICK.message());
            }
