 ...
 * 这样，总共获得了32个可用字符。那么能生成的邀请码总数为32的6次方，也就是1073741824个。
 * 10亿+个邀请码，在业务初期足够用户使用，如果随着业务的发展可对位数进行扩充。
 *
 * @author fangzhijian
 * @since 2025-11-12 16:06
 */
public class ShareCodeUtils {
     ...
     * @return 字符串
     */
    private static String getString(char[] buf, int charPos) {
