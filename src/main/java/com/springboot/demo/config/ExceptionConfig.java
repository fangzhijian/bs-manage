...
public class ExceptionConfig {
    ...
    public ResponseJson constraintViolationException(ConstraintViolationException constraintViolationException, HttpServletRequest request) {
        logErrorRequestInfo(request);
    ...
    public ResponseJson missingParameterException(Exception exception, HttpServletRequest request) {
        logErrorRequestInfo(request);
        ...
        } else if (exception instanceof MissingServletRequestPartException missingPartException) {
    ...
    public ResponseJson exception(Exception e, HttpServletRequest request) {
        logErrorRequestInfo(request);
        if (e instanceof BusinessException) {
            log.error(e.getMessage());
            return ResponseJson.fail(((BusinessException) e).getCode(), e.getMessage());
        } else {
            log.error(e.getMessage());
